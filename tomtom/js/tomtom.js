(function($, window, document){
    const tomtom = {
        ...
        section1(){
            ...
            const sec2Top = $('#section2').offset().top-600;
        ...
        section3(){
            ...
            function mainSlide(){
                ...
                let dragStart=0;
                let dragEnd=0;
                let winWidth = $('#section3 .slide-view').innerWidth();
                $('#section3 .slide-view').on({
                    mousedown(e){
                        winWidth = $('#section3 .slide-view').innerWidth();
                        touchStart =e.clientX;
                        dragStart=e.clientX -$('#section3 .slide-wrap').offset().left-winWidth*2;
                        console.log($('#section3 .slide-wrap').offset().left);
